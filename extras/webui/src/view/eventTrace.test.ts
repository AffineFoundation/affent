    ...
    const items = buildEventTraceItems(normalizeEvents([
      ...
      },
      {
        ...
        data: {
          ...
          exit_code: 0,
          duration_ms: 30,
          result_summary: "SourceAccess: browser_network_url=https://api.taostats.io/subnets/120; requested_url=https://app.taostats.io/subnets/120; ref=n2; source_method=network_xhr_fetch",
          result: "SourceAccess: browser_network_url=https://api.taostats.io/subnets/120; requested_url=https://app.taostats.io/subnets/120; ref=n2; source_method=network_xhr_fetch\n{\"price\":\"0.06342 T\"}",
          result_truncated: false,
        },
      },
    ]));
