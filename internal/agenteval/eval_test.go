...
func TestParseTraceFileReadsToolRequestsAndFinalText(t *testing.T) {
	...
	for _, want := range []string{
		...
		"- capabilities: `workspace:read_file`, `web_fetch`, `web_search`, `session_schedule`, `session_search`, `skill`, `mcp`",
		"## Context Injections",
		"- count: `2`",
