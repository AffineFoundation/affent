...
func TestParseTraceFileReadsToolRequestsAndFinalText(t *testing.T) {
	...
	for _, want := range []string{
		...
		"- request_pressure: estimated_request_input_tokens=`5000`, estimated_conversation_tokens=`3000`, estimated_tool_schema_tokens=`2000`, tool_schema_bytes=`8000`",
