...
func TestParseTraceFileReadsToolRequestsAndFinalText(t *testing.T) {
	...
	body := strings.Join([]string{
		...
		`{"type":"loop.protocol_feed","data":{"turn_id":"t1","loop_id":"longrun","status":"running","mode":"digest","feed_number":4,"protocol_feeds":4,"calibration_answers":1,"last_calibration_answer_preview":"Stop if browser network evidence is missing.","protocol_path":".affent/loops/longrun/LOOP.md","current_situation_preview":"current intent: verify browser network evidence; current risk: dashboard metrics are partial until network refs are read","plan_label":"plan:1/3:active","plan_current_step_index":2,"plan_current_step_status":"in_progress","plan_current_step":"verify browser network evidence","last_turn_id":"turn_previous","last_turn_end_reason":"max_turns","last_turn_tool_requests":5,"last_turn_tool_errors":1,"last_turn_forced_no_tools":1,"last_turn_memory_updates":1,"last_turn_memory_search_calls":3,"last_turn_memory_search_misses":2,"last_turn_session_search_calls":1,"last_turn_loop_guards":1,"last_decision_kind":"evidence_quality","last_decision_trigger":"source_access_dynamic_partial","last_decision":"defer","last_decision_confidence":"high","last_decision_token_budget":300000,"last_decision_observed_input_tokens":120000,"last_decision_projected_input_tokens":250000,"last_decision_reason":"Dynamic widgets had no text values.","last_decision_required_action":"Read browser network responses before citing metrics."}}`,
	...
	for _, want := range []string{
		...
		"- capabilities: `workspace:read_file`, `web_fetch`, `web_search`, `session_search`, `skill`, `mcp`",
		"## Context Injections",
		"- count: `2`",
