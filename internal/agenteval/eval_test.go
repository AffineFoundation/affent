...
func TestParseTraceFileReadsToolRequestsAndFinalText(t *testing.T) {
	...
	body := strings.Join([]string{
		...
		`{"type":"context.compacted","data":{"turn_id":"t1","before_messages":50,"after_messages":18,"removed_messages":32,"before_bytes":120000,"after_bytes":24000,"reduced_bytes":96000,"estimated_input_tokens":120000,"after_estimated_input_tokens":30000,"trigger_input_tokens":70000,"model_context_window_tokens":100000,"reserved_output_tokens":30000,"compact_trigger_input_percent":80,"compact_scope_active":true,"compact_window_ordinal":2,"compact_window_prefill_input_tokens":30000,"compact_scoped_input_tokens":0,"compact_hard_input_limit_tokens":70000,"reactive":true,"reason":"context_overflow","summary_present":true,"summary_bytes":2048,"summary_preview":"USER_CONTEXT: keep market evidence and exact source URLs","loop_protocol_anchor":"LOOP_PROTOCOL: active path=.affent/loops/longrun/LOOP.md mode=digest feed=4 feeds=4 plan=plan:1/3:active current=2:in_progress"}}`,
	...
	for _, want := range []string{
		...
		"GITHUB_TOKEN",
		"policy=estimated_input_tokens=120000,after_estimated_input_tokens=30000,trigger_input_tokens=70000,model_context_window_tokens=100000,reserved_output_tokens=30000,compact_trigger_input_percent=80",
	} {
