...
func TestParseTraceFileReadsToolRequestsAndFinalText(t *testing.T) {
	...
	if len(trace.ContextCompactions) != 1 ||
		...
		trace.ContextCompactions[0].CompactScopedInputTokens != 90000 ||
	...
	for _, want := range []string{
		...
		"- context_policy: model_context_window_tokens=`100000`, model_context_window_auto=`true`, reserved_output_tokens=`30000`, compact_trigger_input_tokens=`70000`, compact_trigger_input_percent=`80`, compact_summary_prompt_max_bytes=`196608`",
		...
		"GITHUB_TOKEN",
		"policy=estimated_input_tokens=120000,trigger_input_tokens=70000,model_context_window_tokens=100000,reserved_output_tokens=30000,compact_trigger_input_percent=80",
	} {
	...
	if compactions.Count != 1 || compactions.Reactive != 1 || compactions.Proactive != 0 || compactions.RemovedMessages != 32 || compactions.ReducedBytes != 96000 || compactions.SummaryBytes != 2048 || compactions.CompactScopeActive != 1 || compactions.MaxCompactScopedInputTokens != 90000 || compactions.MaxCompactHardInputLimit != 70000 {
