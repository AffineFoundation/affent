...
- If a search returns no hits, inspect any recent_sessions anchors in the result and retry once with the most relevant session id or distinctive words from its user/assistant/plan previews.
