...
failed tool events, `conversation.repaired` events, and, when the event log is
missing or incomplete, from structured resume repair placeholders and notes in
`conversation.jsonl`.
